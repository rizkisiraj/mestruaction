...
function UpcomingEvent() {
    return (
        <div className=" w-full h-auto my-10">
            <h2 className="text-[16px] font-semibold">Upcoming Event</h2>
            <div className="h-[250px] w-full flex py-[17px]">
                <Swiper
                    spaceBetween={15}
                    slidesPerView={1.1}
                ...
                >
                    <SwiperSlide className='bg-white rounded-lg border-gray-300 border-[0.5px]'>
                        ...
                        <div className='flex px-5 space-x-6 mt-2.5'>
                            ...
                            <p className='text-[12px] font-semibold'>Sosialisasi  Pentingnya Nutrisi Yang
                                ...
                                Bersama <span className='text-[#E4141D]'>#TeamAksi</span>
                                <br />
                    ...
                    <SwiperSlide className='bg-black rounded-lg'>Slide 3</SwiperSlide>
                </Swiper>
            </div>
        </div>
    )
